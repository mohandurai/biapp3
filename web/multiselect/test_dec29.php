...
$sql = "SELECT max(level) as low2 FROM bi_menus_newch_12_dec_2017 where active=1 and category=".$categ;
// echo $sql . " <<<=== </br>"; 
//exit;
...
$sql3 = "select id, title, tblrowid, tblid, levelid from bi_menus_newch_12_dec_2017 where parent_id=0 and category= " . $categ ." and id NOT IN (SELECT DISTINCT parent_id FROM `bi_menus_newch_12_dec_2017` where parent_id !=0)";
// echo $sql3 . " <<<=== </br>"; 
...
while($row3 = $result3->fetch_assoc()) {
  //echo $row3['id'] . "</br>";  
  $sql3a = "SELECT id, title,tblrowid,tblid,levelid FROM bi_menus_newch_12_dec_2017 where active=1 and category= " . $categ ." and id=".$row3['id'];
...
//echo $cc . " <<<=== </br>"; 
    ...
    $sql2 = "SELECT id, title, parent_id, level,tblrowid,tblid,levelid FROM bi_menus_newch_12_dec_2017 where active=1 and category= " . $categ ." and level=".$cc;
    ...
    if ($result2->num_rows > 0) {
        ...
        while($row2 = $result2->fetch_assoc()) {
            //echo "id: " . $row2["id"]. " - Name: " . $row2["title"] . "<br>";
              ...
              $sql3 = "SELECT id, title, parent_id,tblrowid,tblid,levelid FROM bi_menus_newch_12_dec_2017 where category= " . $categ ." and id=".$row2["parent_id"];
              $result3 = $conn->query($sql3);
              $row3 = $result3->fetch_assoc();
              if($cc==2) {

                $sql3b = "SELECT count(*) as cnt FROM bi_menus_newch_12_dec_2017 where id IN (SELECT DISTINCT parent_id FROM `bi_menus_newch_12_dec_2017` where parent_id !=0) and category= " . $categ ." and id=".$row2["id"];
                //echo $sql3b . "</br>";
                ...
                $sql4 = "SELECT id, title,tblrowid,tblid,levelid FROM bi_menus_newch_12_dec_2017 where category= " . $categ ." and id=".$row3["parent_id"];
              ...
              elseif($cc==4) {
                ...
                $sql4 = "SELECT id, title,tblrowid,tblid FROM bi_menus_newch_12_dec_2017 where category= " . $categ ." and id=".$row3["parent_id"];
                $result4 = $conn->query($sql4);
                $row4 = $result4->fetch_assoc();
