...
?>
  <div id="com-split" style="border-style: solid; border-color: red; color:white; font-size: 14px;">  


    <input id="combsplit" name="combsplit" type="radio" value="0" <?php if($radval==0) echo "checked='checked'"; ?> > Combine </input></br>
    <input id="combsplit" name="combsplit" type="radio" value="1" <?php if($radval==1) echo "checked='checked'"; ?> > Split </input></br></br>
