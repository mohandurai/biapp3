(function($){
	...
	if (converter) {
		...
		if (numHyphen < numHyphen_next) {
		    ...
		    //
		    item = item + '<li>' +"\n";
		    item = item + '<i class="fa fa-chevron-down"></i>' + "\n";
		    item = item + '<label>' + "\n";
	...
	if (typeof(methodName) == "undefined" ) {
		...
		//-------------------options-------------------------------------------------------//
		//change symbols
		if (options.collapsedSymbol != "fa-chevron-down") {
		    $(this).find("i").removeClass("fa-chevron-down").addClass(options.collapsedSymbol);
		}
	...
	expandedSymbol: "fa-chevron-up",
	collapsedSymbol: "fa-chevron-down",
	collapseAll: true,
	checkboxes: "enabled",
