  ...
  ko.bindingHandlers.daterangepicker = (function() {
    return $.extend(this, {
      ...
      update: function(element, valueAccessor, allBindings) {
        ...
        // alert(ko.unwrap(allBindings.get(this._formatKey)));
        ...
        return ko.ignoreDependencies(function() {
          ...
          if (!$element.data('daterangepicker').standalone()) {
            ...
            // {
            //     fulldatemonth = new Date(startDate).getMonth();
            //     // alert(fulldatemonth);
            //     if (fulldatemonth == 0)
            //     {
            //           dateFormat = 'YYYY';
            ...
            //           dateFormat = 'YYYY';
            //           startDateText = moment(startDate).format(dateFormat);
            //           text = 'Q2 '+startDateText;
            //     }
            //     else if (fulldatemonth == 6)
            //     {
            //           dateFormat = 'YYYY';
            //           startDateText = moment(startDate).format(dateFormat);
            //           text = 'Q3 '+startDateText;
            //     }
            //     else //if (fulldatemonth = 'Oct')
            //     {
            //           dateFormat = 'YYYY';
            //           startDateText = moment(startDate).format(dateFormat);
            //           text = 'Q4 '+startDateText;
            //     }
  ...
  CalendarHeaderView = (function() {
    ...
    CalendarHeaderView.prototype.yearOptions = function() {
      ...
      return (function() {
        ...
        //this.currentDate.maxBoundary().year()
