...
(function() {
  ...
  ko.bindingHandlers.daterangepicker = (function() {
    return $.extend(this, {
      ...
      update: function(element, valueAccessor, allBindings) {
        ...
        $element = $(element);
        ref = valueAccessor()(), startDate = ref[0], endDate = ref[0];
        // console.log('123');
  ...
  Period = (function() {
    ...
    Period.allPeriods = ['day', 'week', 'month', 'quarter', 'year', 'finyear'];
  ...
  Config = (function() {
    ...
    Config.prototype._period = function(val) {
      ...
      if (val !== 'day' && val !== 'week' && val !== 'month' && val !== 'quarter' && val !== 'year' && cal !== 'finyear') {
  ...
  CalendarHeaderView = (function() {
    ...
    CalendarHeaderView.prototype.yearOptions = function() {
      ...
      return (function() {
        results = [];
        // alert(this.currentDate.minBoundary().year());
        // alert(this.currentDate.maxBoundary().year());
    ...
    CalendarHeaderView.prototype.decadeOptions = function() {
      return ArrayUtils.uniqArray(this.yearOptions().map((function(_this) {
        return function(year) {
          ...
          // alert(_this.firstYearOfDecade(momentObj).year()+' kdkdfk');
  ...
  CalendarView = (function() {
    ...
    CalendarView.prototype.firstYearOfDecade = function(date) {
      ...
      // alert(MomentUtil.tz([year], this.timeZone()));
