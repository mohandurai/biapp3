...
$all_sql = "select a.class_id,b.module_id,b.module_name,c.question_id,c.question,c.option_A,c.option_B, 
c.option_C,c.option_D,c.option_E,c.num_answers from training_class a,module_master b,question_master c where a.module_id=b.module_id
and b.module_id=c.module_id and a.class_id='".$_REQUEST['classid']."'";
...
$all_sql2 = "select a.class_id,a.class_name,b.module_id,b.module_name,c.question_id,c.question,c.option_A,c.option_B, 
c.option_C,c.option_D,c.option_E,c.num_answers from training_class a,module_master b,question_master c where a.module_id=b.module_id
and b.module_id=c.module_id and a.class_id='".$_REQUEST['classid']."'  group by a.class_id";
...
function backfun()
{
window.location = 'index.php?r=site/quizonline';
}
</script>
<? if($all_nrw2!=0)
{ ?>
