...
//exit;
 ...
 $sql="select a.empspkID, a.title, b.username as emp_name, c.filepath as filelocation, a.created_date, a.description, concat('" . $dynaurl3 . "web/images/',trim(b.profile_image_url)) as profile from empspeak a, user b, documentsupload c 
 		WHERE c.modid=a.empspkID and a.status='O' and FIND_IN_SET(" . $roleid . ",assigned) group by a.empspkID"; 
//echo $sql;
//exit;
...
?>
	...
	?>
		  ...
		  <iframe src="https://docs.google.com/viewer?embedded=true&url=". $dynaurl3 . "web/<?=$file_location?>"  width="600" height="600" scrolling="no"></iframe>
