...
function callCrudAction(action,id,t_id,txt,modname) {
	...
	//alert(queryString);
	jQuery.ajax({
	url: "http://www.tuneem.com/tuneem/web/sms/crud_action.php",
	data:queryString,
	type: "POST",
