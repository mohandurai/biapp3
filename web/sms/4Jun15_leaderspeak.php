...
//$emp_id = $_SESSION['emp_id'];
 $sql="select a.empspkID, a.title, b.username as emp_name, c.filepath as filelocation, a.created_date, a.description, concat('http://tuneem.com/tuneem/web/images/',trim(b.profile_image_url)) as profile from empspeak a, user b, documentsupload c WHERE a.emp_id=b.id and c.modid = a.empspkID and a.status='L'"; 
//echo $sql;
...
<?php
	...
	?>
		  ...
		  <iframe src="https://docs.google.com/viewer?embedded=true&url=http://localhost/surenyii/web/<?=$file_location?>"  width="600" height="600" scrolling="no"></iframe>
...
<?php
    ...
    a.emp_id,
    concat('http://tuneem.com/tuneem/web/images/',
