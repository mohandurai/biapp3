      ...
      function Gradient_svg($HexFrom, $HexTo, $ColorSteps) //, $pers
      {
              ...
              for($i = 0; $i <= $ColorSteps; $i++)
              {
                     // $i=$pers;
                      ...
                      // $GradientColors[] = '#'.(implode(NULL, $HexRGB));#foo
            $GradientColors[] = abs(round($RGB['r']))."_".abs(round($RGB['g']))."_".abs(round($RGB['b']));
              }
              return $GradientColors;
      }
...
// need to config tablename from city level
         ...
         if($ptype == 5)
            {
              ...
              if(!isset($_REQUEST['filter']))
              {
                ...
                if($_REQUEST['parentlvl'] == 12 && $_REQUEST['childlvl'] == 12)
                {
                  ...
                  WHERE ".$parent." ".$conddis." ".$filterchild." a.fld632 != 0 AND a.fld630 != 0 AND a.fld627 != 0 AND a.fld".$tabl_ids."  IN (".$relatedid.") AND a.fld628 != 0 AND a.fld629 != 0 AND a.fld631 != 0 AND a.fld639 != 0 AND a.fld640 != 0 AND a.fld641 != 0 AND a.fld1073 != 0  GROUP BY loclevel ".$groupbyvar." ".$range." order by result desc";
                  // print_r($sql);die;
                }
                 else if($_REQUEST['childlvl'] >= 15)
                {
                  ...
                  WHERE ".$parent."  a.".$child." != 0 AND ".$filterchild." a.fld632 != 0 AND a.fld630 != 0 AND a.fld627 != 0 AND a.fld".$tabl_ids."  IN (".$relatedid.") AND a.fld628 != 0 AND a.fld629 != 0 AND a.fld631 != 0 AND a.fld639 != 0 AND a.fld640 != 0 AND a.fld641 != 0 AND a.fld1073 != 0  GROUP BY loclevel ".$groupbyvar." ".$range." order by result desc";//
                  // print_r($sql);die;
                }
                else
                {
   ...
   $sql2="select ".$yt." as country_id,center_coordinates from ".$res['master_table']."   where ".$text."=".$selectedlocation;
      ...
      //filling white color ,which dont have data
    ...
    //creating new file with -a ,,this map should be called in front end
