        ...
        defaultOptions.exporting = {
            ...
            menuItemDefinitions: {
              ...
              $(".report-container").attr("style","");
               ...
               document.getElementById("chart").style.setProperty("height", "100%", "important");
							 document.getElementById('chart').highcharts().setSize(516, 390, false);
							// document.getElementsByClassName( 'map-container' ).style.display = 'block';
							// document.getElementsByClassName( 'report-container' ).style.display = 'block';
						}
						else
						{
              $(".chart-container").attr("style","height:100%;width:99%;");
              $(".map-container").attr("style","display:none;");
              $(".report-container").attr("style","display:none;");
							 document.getElementById("chart").style.setProperty("width", "100%", "important");
							 document.getElementById('chart').highcharts().setSize($(window).width(), 516, false);
							// document.getElementsByClassName( 'map-container' ).style.display = 'none';
							// document.getElementsByClassName( 'report-container' ).style.display = 'none';
						}

                        // example
                       //Highcharts.chart.setSize(100,100);
                    }
                },
                  ...
                  legendshow: {
                    ...
                    if(value=="Show Legend")
                    {
                        ...
                        $("#cl").show();
                     //console.log(  $("#legendlabel").html());
                    }
    // TODO: do something with the value
                     });
                          // alert("type"+ $('.highcharts-menu-item').html());


     // if($('.highcharts-menu-item').val()=='Show Legend')
     // {
     //    alert("aaaa");
     // }


                        var theModal = $("#myModalpop").modal({
                                  show: true
                         });
