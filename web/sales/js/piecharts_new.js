...
/***/ (function(module, exports, __webpack_require__) {
	...
	function draw(adjustedPointsAndAnglesOnPerimeter, radius, strokeSize, colors, strokeColor) {
		// console.log('adjustedPointsAndAnglesOnPerimeter');
		// console.log(adjustedPointsAndAnglesOnPerimeter);
	    ...
	    //         	console.log('iteration');
	     ...
	     //        	{
						...
						// array = array(13.947823061489254,7.853085403836032,7);
						// xy_cus = array(13.9478230614892541,7.8530854038360322,7);
						// xy1_cus = array(14,6.999999999999998,360);
						// xy = array(xy_cus,xy1_cus);
	...
	function generatePointsAndAnglesOnCirclePerimeter(values, colors, radius, strokeSize) {
	    ...
	    // console.log('pointsAndAnglesOnPerimeter');
	    // console.log(pointsAndAnglesOnPerimeter);
	    // if(pointsAndAnglesOnPerimeter[0][2] == 0)
	    // {
	    // 	pointsAndAnglesOnPerimeter[0][2] = 3
	    // }
	    // if(pointsAndAnglesOnPerimeter[0][2] == 0)
	    // {
	    // 	pointsAndAnglesOnPerimeter[0][2] = 3
	...
	function generatePieChartSVG(values, colors, radius) {
	    ...
	    var val =0;
	    // alert(strokeColor);
		if(values.length == 2)//coded by robin...if percentage is 99 and 0.2 gets error,so checking percentage
		{
			val = values[0]-values[1];
			val = Math.abs(val);
			var val2 = val/(values[0]+values[1])
			val2 =val2*100;
			val = val2;
			// console.log('val2');
			// console.log(val2);
		}
		if(val > 99) //if percentage greater than 99.will reset to below to avoid error ,,robin
		{
			values[0] = 1101423.1;
			values[1] = 114013147.19;
		}
	    try {
	    ...
	    // alert(adjustedPointsAndAnglesOnPerimeter);
		// console.log('inputs');
		// console.log(adjustedPointsAndAnglesOnPerimeter);
		// console.log(radius);
		// console.log(strokeSize);
