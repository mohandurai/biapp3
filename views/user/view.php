...
?>
<div class="user-view ie-botscrol">
   ...
   <div class = "tab-pane fade in active" id = "home">
      ...
      <?= DetailView::widget([
        ...
        //    'password_reset_token',
            ...
            'format'=>'raw',
            'value'=>Html::a('Reset Password', ['change_password', 'id' => $model->id,'username' =>$model->username]),
        ],
            'status',
'role',
//'dp',
...
[                     
            ...
            'value' => date("d-M-Y",  strtotime($model->date_of_joining)),
        ],
'date_of_promotion',
'exp_current_job',
'exp_prevoius_job',
...
[                     
            ...
            'value' => date("d-M-Y",  strtotime($model->date_of_leaving)),
        ],
//'remarks',
'created_by',
'modified_by',
...
[                     
            ...
            'value' => date("d-M-Y",  strtotime($model->qualification_date)),
        ],
'gender',
'street_name',
//'neev_designation',
...
'segment',
	...
	[                     
            ...
            'value' => date("d-M-Y",  strtotime(gmdate("Y-m-d H:i:s", $model->created_at ) )+ + 5 * 3600 + 30 * 60 ),
        ],
	[                     
            'attribute' => 'updated_at',
            'value' => date("d-M-Y",  strtotime(gmdate("Y-m-d H:i:s", $model->updated_at ) )+ + 5 * 3600 + 30 * 60 ),
        ],
