...
echo 'SELECT status FROM crt_participant where crt_id="'.$cid.'" and empid="'.$uid.'"';

$cont= $infocnt1[0]['status'];
if($cont==""){

	echo $sql5= "update crt_nominations set comment='$comm',category_status='$category' where crt_id='$cid' and emp_id='$uid'";
...
//echo "Accepted ";
header('Location: http://www.tuneem.com/tuneem/web/index.php?r=site%2Fnamination&id=10');
}
else{
//echo "Rejected ";
header('Location: http://www.tuneem.com/tuneem/web/index.php?r=site%2Fnamination&id=10');
