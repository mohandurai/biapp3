...
$sql2="SELECT a.empid,a.info_id,a.status,a.max_mark,a.max_score,
...
ifnull(truncate((ifnull(sum(a.max_score),0)/ifnull(sum(a.max_mark),0))*100,2),0) as percentage,a.attempt_date
 FROM infonugget_participant a,user b where a.id='".$ojt_participant_id."' and a.status='Closed' and a.empid=b.id and a.empid='".$userid."'";
