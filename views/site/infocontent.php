...
<div>
						 ...
						 <?  $infocnt = Yii::$app->db->createCommand('SELECT content,title as info FROM  info_nuggets where info_nuggest_id="'.$id.'"')->queryAll();
...
<center>
<iframe src="<?=$baseurl1 ?>" style="width:100%; height:500px;" frameborder="0" class="survey-border"></iframe>
					</center>
