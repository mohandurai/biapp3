...
window.location.assign("index.php?r=site/naminationtest&cid="+cid+"&eid="+eid+"&comm="+comm+"&cate="+cate);
} 
...
?>
	...
	$infocnt = Yii::$app->db->createCommand('SELECT distinct emp_id,category_status FROM  crt_nominations where crt_id="'.$id.'" ')->queryAll();
