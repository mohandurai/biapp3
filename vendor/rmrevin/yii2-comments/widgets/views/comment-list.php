...
$this->registerJs(
   '$("document").ready(function(){ 
		...
		$("#paxcommentslist").on("pjax:beforeSend", function() {
		
		$("#paxcommentslist").empty();
		});
   
        $("#paxcommentslist").on("pjax:end", function(e) {
 ...
 <?php  Pjax::begin(['id' => 'paxcommentslist']) ; ?>
            ...
            <div <?= Html::renderTagAttributes($options) ?>>
                <div class="col-lg-12">
                    <div class="author">
                        <?php
                        $avatar = false;
                        $name = Yii::t('app',$Comment->useruser->username);
                        $url = false;
		...
		/*		 echo Html::a(FA::icon('reply') . ' ' . Yii::t('app', 'Reply'), '#', [
                            ...
                            if ($Comment->canUpdate()) {
                                echo Html::a(
                                    ...
                                    [
                                        ...
                                        'value' => $Comment->text,
                                        'class' => 'btn btn-primary btn-xs  edt',
                            ...
                            if ($Comment->canDelete()) {
                                echo Html::a(
                                    ...
                                    '#',['name' => 'dlt', 'delete-comment' => $Comment->id, 
                                    'class' => 'btn btn-danger btn-xs  dlt']
                                );
                            }
                        }
                        ?>
