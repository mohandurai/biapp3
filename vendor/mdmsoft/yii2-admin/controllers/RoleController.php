...
$command = $connection->createCommand(
		"UPDATE role_structure SET role_structure='".$_POST['data']."' WHERE id=1");
$command->execute();


//print_r(json_decode($_REQUEST['flat']));

$roleflat=json_decode($_REQUEST['flat']);
...
$command = $connection->createCommand(
		"UPDATE auth_item SET reports_to_role='".$roleflat[$i]->parent."' WHERE name='".$roleflat[$i]->id."'");
$command->execute() ;
