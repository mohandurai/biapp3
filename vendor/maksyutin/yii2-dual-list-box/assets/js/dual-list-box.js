...
(function($) {
    ...
    function createDualListBox(options) {
        ...
        $(options.parentElement).addClass('row').append(
                ...
                '       <select class="unselected unselected'+options.parent+'" style="height: 200px; width: 100%;" multiple></select>' +
                '   </div>' +
                (options.horizontal == false ? createVerticalButtons(options.moveAllBtn,options.parent) : '') +
                (options.horizontal == false ? '   <div class="col-md-5">' : '   <div class="col-md-6">') +
                ...
                '       <select class="selected selected'+options.parent+'" style="height: 200px; width: 100%;" multiple></select>' +
                '   </div>');
    ...
    function createVerticalButtons(copyAllBtn, parent) {
        return '   <div class="col-md-2 center-block" style="margin-top: ' + (copyAllBtn ? '80px' : '130px') +'">' +
            ...
            '       <button type="button" id="allright" class="allright'+parent+' btn btn-default col-md-8 col-md-offset-2 str" data-type="str" style="margin-bottom: 20px;" disabled><span class="glyphicon glyphicon-chevron-right"></span></button>' +
